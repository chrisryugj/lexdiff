...
| 🔴 긴급 | 조문명 | 필요 조치 설명 |
| 🟡 검토 | 조문명 | 필요 조치 설명 |
| 🟢 참고 | 조문명 | 실질 변경 없음 – 별도 조치 불필요 |

**중요**: 우선순위는 반드시 각 항목의 "등급" 값을 따르세요:
- critical → 🔴 긴급
- review → 🟡 검토
- info → 🟢 참고
등급과 다른 우선순위를 임의로 부여하지 마세요.

**문체 규칙**:
- 개조식(명사형 종결)으로 통일. 예: "점검 필요", "조치 불필요", "검토 대상"
- "~합니다", "~입니다" 같은 존댓말 금지
- 표 안의 조치도 개조식. 예: "임용 기준 변경 확인 및 내부 규정 반영 필요"
