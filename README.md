...
[![Version](https://img.shields.io/badge/version-2.5.1--beta-b08d57)](CHANGELOG.md)
...
* **⚡ 신구조문 비교** — 개정 전후 변경점을 색깔로 하이라이팅. AI가 "뭐가 바뀌었는지" 한 줄로 요약해줍니다. **개정 연혁에서 원하는 시점을 골라** 그 시점의 신·구 대조와 AI 해설을 볼 수 있습니다.
...
* **📖 판례·해석례 통합** — 대법원 판례, 법제처 해석례, 조세심판원 재결례, 관세청 해석을 한 곳에서 검색. 법령 전문을 스크롤하면 **화면의 조문을 따라 관련 판례가 실시간 갱신**되는 라이브 판례 패널.
* **🔤 약칭·구어 검색** — "인공지능법 30조"처럼 비공식 약칭으로 검색해도 공식 약칭·정식 법령명("인공지능기본법")을 자동 해소해 해당 조문으로 바로 이동.
...
- 키 형식: `AIzaSy...` (39자) 또는 신형 `AQ....` (Google AI Studio 발급)
