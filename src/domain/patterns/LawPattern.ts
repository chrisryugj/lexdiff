...
// 주의: "기준/조건/대상/절차" 명사형 종결은 행정규칙명("~확보조치 기준")과
//       충돌해 오분류 유발 → 제외. "방법/요건"은 AI 질문으로 남김 (진짜 질문 문맥 흔함)
// 주의: `니까?$`는 "~입니까/습니까"만 매칭, "~있나요"는 `나요$`로 별도 매칭
export const QUESTION_ENDINGS = /[?？]$|인가요?$|인지요?$|될까요?$|되나요?$|습니까?$|니까?$|나요$|알려줘|설명해줘|가르쳐줘|말해줘|찾아줘|보여줘|궁금|뭐야|뭐지|뭔지|뭘까$|방법$|요건$/
