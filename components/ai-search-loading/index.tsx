    ...
    <div className={cn("space-y-6", className)}>
      ...
      {meta && (meta.queryType || meta.keywords?.length) && (
        <div className="flex flex-wrap items-center gap-2 px-4 py-3 bg-muted/20 rounded-lg text-sm">
          ...
          {meta.domain && (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-brand-navy/10 text-brand-navy rounded-full">
              <Icon name="book-open" className="h-3.5 w-3.5" />
              {meta.domain}
            </span>
          )}
          {meta.keywords && meta.keywords.length > 0 && (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-brand-gold/10 text-brand-gold rounded-full">
